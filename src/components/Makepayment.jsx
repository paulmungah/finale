...
const Makepayment = () => {
  ...
  // Auto format phone number (add 254 if missing)
    ...
    <div style={styles.wrapper}>
      ...
      >
          ...
          <div style={styles.productInfo}>
            ...
            <div style={styles.amountContainer}>
              ...
              <div style={styles.amount}>
                KES <span style={styles.amountValue}>{Number(product.product_cost).toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {loading ? "SENDING STK PUSH..." : `PAY KES ${Number(product.product_cost).toLocaleString()} NOW`}
          </motion.button>
        </form>
...
const styles = {
  ...
  divider: {
    height: "1px",
    background: "linear-gradient(90deg, transparent, rgba(52,168,83,0.3), transparent)",
    margin: "24px 0",
  },
  ...
  payButton: {
    ...
    letterSpacing: "0.6px",
    cursor: "pointer",
    boxShadow: "0 15px 35px rgba(15, 157, 88, 0.5)",
    transition: "all 0.3s ease",
  },
